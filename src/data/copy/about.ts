...
export const aboutCopy: AboutPageCopy = {
  seo: {
    ...
    description:
      'Full Stack Systems Engineer at Eresolution Consultancy Services & Co-Founder at SquadCoders. Learn about my technical background, core engineering philosophy, and architectural standards.',
    image: '/og/about.png',
  },
  hero: {
    eyebrow: 'About',
    ...
    groups: [
      {
        ...
        value: 'TypeScript, JavaScript (ES2023+), Typst, Go, Python, Node.js, Bun, HTML5, SQL.',
      },
      {
      ...
      },
      {
        ...
        value: 'PostgreSQL, MySQL, SQLite / D1, Redis, Cloudflare KV & R2, MongoDB.',
      },
      {
